      ...
      <div class="row rm-gen-details">
        ...
        <div class="col-md-10 rm-information">
          ...
          <div class="location-status">
            <div class="row">
              <div class="col-md-3"><span class="location">Location</span></div>
              <div class="col-md-3"><span class="available-status">Available</span></div>
              <div class="col-md-3"><button class="reserve-inline btn btn-default">Reserve</button></div>
              <div class="col-md-3"><span class="availability-date">Returned by: </span> 09/30/2017</div>
            </div> 
          </div>
      ...
      <div class="rm-reviews">
        ...
        <div class="write-review divider">
          ...
          <form class="form-inline" align="center">
            ...
            <textarea class="form-control" placeholder="Tell us what you think" rows="2" style="width: 80%; margin-right: 20px;" ></textarea>
